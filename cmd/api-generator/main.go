...
func (g *generator) genRouter(routers []Router) {
	...
	g.WriteString("\"github.com/Ovler-Young/go-cqhttp/coolq\"\n")
	g.WriteString("\"github.com/Ovler-Young/go-cqhttp/global\"\n")
	g.WriteString("\"github.com/Ovler-Young/go-cqhttp/pkg/onebot\"\n")
	g.WriteString(")\n\n")
